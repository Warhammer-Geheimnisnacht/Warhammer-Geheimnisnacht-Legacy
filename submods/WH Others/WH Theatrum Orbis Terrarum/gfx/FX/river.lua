...
float4 main( VS_OUTPUT In ) : COLOR
{
	...
	float3 vColor = lerp( vBottom, vWaterSurface.xyz, vWaterSurface.a * 0.66f ); // changed from 0.8 to 0.66
	...
	float vFoW = GetFoW( In.vPrePos_Fade.xyz, FoWTexture, FoWDiffuse )*.66; //added *0.66
